...
import { t as require_google_protobuf } from "./google-protobuf-DshEgFcz.js";

//#region node_modules/google-protobuf/google/protobuf/struct_pb.js
var require_struct_pb = /* @__PURE__ */ __commonJS({ "node_modules/google-protobuf/google/protobuf/struct_pb.js": ((exports) => {
	/**
	* @fileoverview
	* @enhanceable
 ...
 /**
		...
		while (reader.nextField()) {
			...
			switch (reader.getFieldNumber()) {
				case 1:
					...
					reader.readMessage(value, function(message, reader$1) {
						jspb.Map.deserializeBinary(message, reader$1, jspb.BinaryReader.prototype.readStringRequireUtf8, jspb.BinaryReader.prototype.readMessage, proto.google.protobuf.Value.deserializeBinaryFromReader, "", new proto.google.protobuf.Value());
					});
					break;
				default:
					reader.skipField();
	...
	*/
	proto.google.protobuf.Struct.serializeBinaryToWriter = function(message, writer) {
		...
		if (f && f.getLength() > 0) jspb.internal.public_for_gencode.serializeMapToBinary(message.getFieldsMap(true), 1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.google.protobuf.Value.serializeBinaryToWriter);
	};
	/**
	...
	* @const
	*/
	proto.google.protobuf.Value.oneofGroups_ = [[
		1,
		2,
		3,
		4,
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.google.protobuf.Value.toObject = function(includeInstance, msg) {
			var f, obj = {
				nullValue: (f = jspb.Message.getField(msg, 1)) == null ? void 0 : f,
				numberValue: (f = jspb.Message.getOptionalFloatingPointField(msg, 2)) == null ? void 0 : f,
				stringValue: (f = jspb.Message.getField(msg, 3)) == null ? void 0 : f,
				boolValue: (f = jspb.Message.getBooleanField(msg, 4)) == null ? void 0 : f,
		...
		while (reader.nextField()) {
			...
			switch (reader.getFieldNumber()) {
				...
				case 2:
					...
					break;
				case 3:
					var value = reader.readStringRequireUtf8();
	...
	*/
	proto.google.protobuf.Value.serializeBinaryToWriter = function(message, writer) {
		...
		if (f != null) writer.writeEnum(1, f);
		f = jspb.Message.getField(message, 2);
		if (f != null) writer.writeDouble(2, f);
		f = jspb.Message.getField(message, 3);
		if (f != null) writer.writeString(3, f);
		f = jspb.Message.getField(message, 4);
		if (f != null) writer.writeBool(4, f);
		f = message.getStructValue();
		if (f != null) writer.writeMessage(5, f, proto.google.protobuf.Struct.serializeBinaryToWriter);
		f = message.getListValue();
		if (f != null) writer.writeMessage(6, f, proto.google.protobuf.ListValue.serializeBinaryToWriter);
	};
	/**
	...
	if (jspb.Message.GENERATE_TO_OBJECT) {
		...
		*/
		proto.google.protobuf.ListValue.toObject = function(includeInstance, msg) {
			var obj = { valuesList: jspb.Message.toObjectList(msg.getValuesList(), proto.google.protobuf.Value.toObject, includeInstance) };
			if (includeInstance) obj.$jspbMessageInstance = msg;
			return obj;
		};
	}
	...
	*/
	proto.google.protobuf.ListValue.serializeBinaryToWriter = function(message, writer) {
		...
		if (f.length > 0) writer.writeRepeatedMessage(1, f, proto.google.protobuf.Value.serializeBinaryToWriter);
	};
	/**
	...
	*/
	proto.google.protobuf.ListValue.prototype.toJavaScript = function() {
		...
		for (var i = 0; i < values.length; i++) ret[i] = values[i].toJavaScript();
		return ret;
	};
	/**
	...
	*/
	proto.google.protobuf.ListValue.fromJavaScript = function(array) {
		...
		for (var i = 0; i < array.length; i++) ret.addValues(proto.google.protobuf.Value.fromJavaScript(array[i]));
		return ret;
	};
	/**
...
//#endregion
export default require_struct_pb();

//# sourceMappingURL=google-protobuf_google_protobuf_struct_pb.js.map