...
var require_google_protobuf = /* @__PURE__ */ __commonJS({ "node_modules/google-protobuf/google-protobuf.js": ((exports) => {
	...
	goog.exportPath_ = function(a, b, c, d) {
		...
		for (var e; a.length && (e = a.shift());) if (a.length || void 0 === b) d = d[e] && d[e] !== Object.prototype[e] ? d[e] : d[e] = {};
	...
	function module$contents$goog$object_unsafeClone(a) {
		...
		for (const c in a) b[c] = module$contents$goog$object_unsafeClone(a[c]);
		return b;
	}
	...
	function module$contents$goog$object_extend(a, b) {
		...
		for (let e = 1; e < arguments.length; e++) {
			d = arguments[e];
			for (c in d) a[c] = d[c];
			for (let f = 0; f < module$contents$goog$object_PROTOTYPE_FIELDS.length; f++) c = module$contents$goog$object_PROTOTYPE_FIELDS[f], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]);
		}
	}
	...
	var module$contents$goog$array_map = goog.NATIVE_ARRAY_PROTOTYPES && (module$contents$goog$array_ASSUME_NATIVE_FUNCTIONS || Array.prototype.map) ? function(a, b, c) {
		...
		for (let g = 0; g < d; g++) g in f && (e[g] = b.call(c, f[g], g, a));
		return e;
	};
	...
	var module$contents$goog$array_some = goog.NATIVE_ARRAY_PROTOTYPES && (module$contents$goog$array_ASSUME_NATIVE_FUNCTIONS || Array.prototype.some) ? function(a, b, c) {
		...
		const d = a.length, e = "string" === typeof a ? a.split("") : a;
		for (let f = 0; f < d; f++) if (f in e && b.call(c, e[f], f, a)) return !0;
		return !1;
	};
	...
	var module$contents$goog$array_every = goog.NATIVE_ARRAY_PROTOTYPES && (module$contents$goog$array_ASSUME_NATIVE_FUNCTIONS || Array.prototype.every) ? function(a, b, c) {
		...
		const d = a.length, e = "string" === typeof a ? a.split("") : a;
		for (let f = 0; f < d; f++) if (f in e && !b.call(c, e[f], f, a)) return !1;
		return !0;
	};
	...
	function module$contents$goog$array_clear(a) {
		if (!Array.isArray(a)) for (let b = a.length - 1; 0 <= b; b--) delete a[b];
		a.length = 0;
	}
	...
	function module$contents$goog$array_flatten(a) {
		...
		for (let d = 0; d < arguments.length; d++) {
			...
			if (Array.isArray(e)) for (let f = 0; f < e.length; f += 8192) {
				...
				for (let g = 0; g < c.length; g++) b.push(c[g]);
			}
			else b.push(e);
		}
		return b;
	...
	jspb.Map.deserializeBinary = function(a, b, c, d, e, f, g) {
		for (; b.nextField() && !b.isEndGroup();) {
			...
			1 == h ? f = c.call(b) : 2 == h && (a.valueCtor_ ? (jspb.asserts.assert(e), g ||= new a.valueCtor_(), d.call(b, g, e)) : g = d.call(b));
		}
	...
	goog.labs = {};
	goog.labs.userAgent = {};
	var module$contents$goog$labs$userAgent_USE_CLIENT_HINTS_OVERRIDE = "", module$contents$goog$labs$userAgent_USE_CLIENT_HINTS = !1;
	...
	var module$contents$goog$labs$userAgent_useClientHintsRuntimeOverride = !1;
	...
	var module$exports$goog$labs$userAgent$highEntropy$highEntropyValue = {
		...
		HighEntropyValue: class {
			...
			async load() {
				...
				if (a) return this.promise_ || (this.pending_ = !0, this.promise_ = (async () => {
					try {
	...
	function module$contents$goog$labs$userAgent$browser_getFullVersionFromUserAgentString(a) {
		...
		switch (a) {
			...
			case module$contents$goog$labs$userAgent$browser_Brand.EDGE:
				...
				break;
			case module$contents$goog$labs$userAgent$browser_Brand.CHROMIUM: if (module$contents$goog$labs$userAgent$browser_matchChrome()) return c([
				"Chrome",
				"CriOS",
				"HeadlessChrome"
			]);
	...
	var module$contents$goog$labs$userAgent$browser_HighEntropyBrandVersion = class {
		...
		getIfLoaded() {
			if (this.useUach_) {
				...
				if (void 0 !== a) return a = a.find(({ brand: b }) => this.brand_ === b), (0, goog.asserts.assertExists)(a), new module$exports$goog$labs$userAgent$highEntropy$highEntropyValue.Version(a.version);
			}
	...
	function module$contents$goog$labs$userAgent$browser_fullVersionOf(a) {
		...
		if (c) {
			if (!module$contents$goog$labs$userAgent$util_getUserAgentData().brands.find(({ brand: d }) => d === a)) return;
		} else if ("" === b) return;
	...
	var module$contents$goog$labs$userAgent$platform_PlatformVersion = class {
		...
		async load() {
			if (module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform(!0)) return new module$exports$goog$labs$userAgent$highEntropy$highEntropyValue.Version(await module$exports$goog$labs$userAgent$highEntropy$highEntropyData.platformVersion.load());
	...
	goog.crypt.base64.encodeByteArray = function(a, b) {
		...
		for (; e < a.length - 2; e += 3) {
			var g = a[e], h = a[e + 1], l = a[e + 2], k = b[g >> 2];
			g = b[(g & 3) << 4 | h >> 4];
			h = b[(h & 15) << 2 | l >> 6];
			l = b[l & 63];
			c[f++] = "" + k + g + h + l;
		...
		l = d;
		switch (a.length - e) {
			case 2: k = a[e + 1], l = b[(k & 15) << 2] || d;
			case 1: a = a[e], c[f] = "" + b[a >> 2] + b[(a & 3) << 4 | k >> 4] + l + d;
		}
		return c.join("");
	};
	...
	goog.crypt.base64.decodeStringInternal_ = function(a, b) {
		function c(l) {
			for (; d < a.length;) {
				var k = a.charAt(d++), n = goog.crypt.base64.charToByteMap_[k];
				if (null != n) return n;
	...
	function module$contents$jspb$binary$errors_messageLengthMismatchError(a, b) {
		return Error(`Message parsing ended unexpectedly. Expected to read ${a} bytes, instead read ${b} bytes, either the data ended unexpectedly or the message misreported its own length`);
	}
	...
	function module$contents$jspb$binary$errors_invalidFieldNumberError(a, b) {
		return Error(`Invalid field number: ${a} (at position ${b})`);
	}
	...
	function module$contents$jspb$binary$errors_negativeByteLengthError(a) {
		return Error(`Tried to read a negative byte length: ${a}`);
	}
	...
	module$exports$jspb$internal_bytes.USE_ATOB_BTOA = module$contents$jspb$internal_bytes_ASSUME_ATOB_AND_BTOA_AVAILABLE || !goog.userAgent.IE && "function" === typeof btoa;
	...
	function module$contents$jspb$internal_bytes_encodeByteArray(a) {
		...
		let b = "", c = 0;
		const d = a.length - module$contents$jspb$internal_bytes_UINT8ARRAY_MAX_SIZE_FOR_SPREAD;
	...
	function module$contents$jspb$internal_bytes_decodeByteArray(a) {
		...
		var b = a;
		b = module$contents$jspb$internal_bytes_replaceWebsafeString(b);
		let c;
		if (goog.DEBUG) try {
			c = atob(b);
		} catch (d) {
			throw Error(`invalid encoding '${a}': ${d}`);
		}
		else c = atob(b);
	...
	function module$contents$jspb$binary$utf8_getFatalDecoderInstance() {
		let a = module$contents$jspb$binary$utf8_fatalDecoderInstance;
		a ||= module$contents$jspb$binary$utf8_fatalDecoderInstance = new TextDecoder("utf-8", { fatal: !0 });
		return a;
	}
	...
	function module$contents$jspb$binary$utf8_getNonFatalDecoderInstance() {
		let a = module$contents$jspb$binary$utf8_nonFatalDecoderInstance;
		a ||= module$contents$jspb$binary$utf8_nonFatalDecoderInstance = new TextDecoder("utf-8", { fatal: !1 });
		return a;
	}
	...
	var module$contents$jspb$binary$utf8_useTextDecoderDecode = module$contents$jspb$binary$utf8_ASSUME_TEXT_ENCODING_AVAILABLE || "undefined" !== typeof TextDecoder;
	...
	function module$contents$jspb$binary$utf8_textEncoderEncode(a, b) {
		...
		return (module$contents$jspb$binary$utf8_textEncoderInstance ||= new TextEncoder()).encode(a);
	}
	var module$contents$jspb$binary$utf8_IS_WELL_FORMED = "isWellFormed", module$contents$jspb$binary$utf8_HAS_WELL_FORMED_METHOD = 2023 < goog.FEATURESET_YEAR || "function" === typeof String.prototype[module$contents$jspb$binary$utf8_IS_WELL_FORMED];
	...
	var module$contents$jspb$binary$utf8_useTextEncoderEncode = module$contents$jspb$binary$utf8_ASSUME_TEXT_ENCODING_AVAILABLE || "undefined" !== typeof TextEncoder;
	function module$contents$jspb$binary$utf8_encodeUtf8(a, b = !1) {
	...
	jspb.bytestring = {};
	var module$contents$jspb$bytestring_ByteString = class module$contents$jspb$bytestring_ByteString {
		static fromBase64(a) {
			(0, goog.asserts.assertString)(a);
		...
		static async fromBlob(a) {
			(0, goog.asserts.assertInstanceof)(a, Blob);
			if (0 === a.size) return module$contents$jspb$bytestring_ByteString.empty();
			a = await a.arrayBuffer();
			return new module$contents$jspb$bytestring_ByteString(new Uint8Array(a), module$exports$jspb$internal_bytes.I_AM_INTERNAL);
		}
		static empty() {
		...
		sizeBytes() {
			const a = this.internalBytesUnsafe(module$exports$jspb$internal_bytes.I_AM_INTERNAL);
			return a ? a.length : 0;
		}
		unsignedByteAt(a) {
			(0, goog.asserts.assertNumber)(a);
			(0, goog.asserts.assert)(0 <= a, "index %s should be non-negative", a);
			const b = this.internalBytesUnsafe(module$exports$jspb$internal_bytes.I_AM_INTERNAL);
		...
		asStringUtf8({ parsingErrorsAreFatal: a = !0 } = {}) {
			const b = this.internalBytesUnsafe(module$exports$jspb$internal_bytes.I_AM_INTERNAL);
	...
	jspb.utils = {};
	var module$contents$jspb$utils_SUPPORTS_UINT8ARRAY_SLICING = 2018 <= goog.FEATURESET_YEAR || "function" === typeof Uint8Array.prototype.slice, module$contents$jspb$utils_MAX_SCRATCHPAD_BYTES = 8;
	...
	function module$contents$jspb$utils_splitInt64(a) {
		if (0 > a) {
			...
			const [b, c] = module$contents$jspb$utils_negate(module$contents$jspb$utils_split64Low, module$contents$jspb$utils_split64High);
	...
	function module$contents$jspb$utils_splitFloat32(a) {
		const b = module$contents$jspb$utils_getScratchpad(4);
		b.setFloat32(0, +a, !0);
	...
	function module$contents$jspb$utils_joinUint64(a, b) {
		const c = b * module$contents$jspb$BinaryConstants_TWO_TO_32 + (a >>> 0);
	...
	function module$contents$jspb$utils_joinSignedNumberOrDecimalString(a, b) {
		const c = module$contents$jspb$utils_joinInt64(a, b);
	...
	function module$contents$jspb$utils_joinUnsignedNumberOrDecimalString(a, b) {
		b >>>= 0;
		const c = module$contents$jspb$utils_joinUint64(a, b);
		return Number.isSafeInteger(c) ? c : module$contents$jspb$utils_joinUnsignedDecimalString(a, b);
	}
	function module$contents$jspb$utils_joinNegativeDecimalStringFallback(a, b) {
		const [c, d] = module$contents$jspb$utils_negate(a, b);
		a = c;
		b = d;
	...
	var module$contents$jspb$binary$decoder_BinaryDecoder = class module$contents$jspb$binary$decoder_BinaryDecoder {
		constructor(a, b, c, d) {
		...
		init(a, b, c, { aliasBytesFields: d = !1, treatNewDataAsImmutable: e = !1 } = {}) {
			this.aliasBytesFields = d;
			this.treatNewDataAsImmutable = e;
			a && this.setBlock(a, b, c);
		}
		static alloc(a, b, c, d) {
			if (module$contents$jspb$binary$decoder_BinaryDecoder.instanceCache_.length) {
				const e = module$contents$jspb$binary$decoder_BinaryDecoder.instanceCache_.pop();
				e.init(a, b, c, d);
				return e;
			}
		...
		static readSplitZigzagVarint64(a, b) {
			return module$contents$jspb$binary$decoder_BinaryDecoder.readSplitVarint64(a, (c, d) => module$contents$jspb$utils_fromZigzag64(c, d, b));
		}
		static readSplitFixed64(a, b) {
			const c = a.bytes_, d = a.cursor_;
			a.advance(8);
			let e = a = 0;
			for (let f = d + 7; f >= d; f--) a = a << 8 | c[f], e = e << 8 | c[f + 4];
			return b(a, e);
		}
		skipVarint() {
		...
		static readSignedVarint32(a) {
			const b = a.bytes_;
			let c = a.cursor_, d = b[c++], e = d & 127;
		...
		static readUint8(a) {
			const b = a.bytes_[a.cursor_ + 0];
			a.advance(1);
			return b;
		}
		static readUint16(a) {
			const b = a.bytes_[a.cursor_ + 0], c = a.bytes_[a.cursor_ + 1];
			a.advance(2);
			return b << 0 | c << 8;
		}
		static readUint32(a) {
			var b = a.bytes_;
			const c = a.cursor_, d = b[c + 0], e = b[c + 1], f = b[c + 2];
			b = b[c + 3];
			a.advance(4);
			return (d << 0 | e << 8 | f << 16 | b << 24) >>> 0;
		}
		static readUint64(a) {
			const b = module$contents$jspb$binary$decoder_BinaryDecoder.readUint32(a);
			a = module$contents$jspb$binary$decoder_BinaryDecoder.readUint32(a);
			return module$contents$jspb$utils_joinUint64(b, a);
		}
		static readUint64String(a) {
			const b = module$contents$jspb$binary$decoder_BinaryDecoder.readUint32(a);
			a = module$contents$jspb$binary$decoder_BinaryDecoder.readUint32(a);
		...
		readDoubleArrayInto(a, b) {
			...
			else if (module$contents$jspb$binary$decoder_OPTIMIZE_LITTLE_ENDIAN_MACHINES && module$contents$jspb$binary$decoder_isLittleEndian()) for (this.cursor_ += d, a = new Float64Array(e.buffer.slice(c, c + d)), d = 0; d < a.length; d++) b.push(a[d]);
			else for (d = 0; d < a; d++) b.push(module$contents$jspb$binary$decoder_BinaryDecoder.readDouble(this));
		}
		static readBool(a) {
			let b = 0, c = a.cursor_;
			const d = c + module$contents$jspb$binary$decoder_MAX_VARINT_SIZE, e = a.bytes_;
			for (; c < d;) {
				const f = e[c++];
				b |= f;
	...
	var module$contents$jspb$binary$decoder_ASSUME_DATAVIEW_IS_FAST = 2019 <= goog.FEATURESET_YEAR, module$contents$jspb$binary$decoder_OPTIMIZE_LITTLE_ENDIAN_MACHINES = !0;
	...
	var module$contents$jspb$binary$reader_BinaryReader = class module$contents$jspb$binary$reader_BinaryReader {
		constructor(a, b, c, d) {
		...
		setOptions({ discardUnknownFields: a = !1 } = {}) {
			this.discardUnknownFields = a;
		}
		static alloc(a, b, c, d) {
			if (module$contents$jspb$binary$reader_BinaryReader.instanceCache_.length) {
				const e = module$contents$jspb$binary$reader_BinaryReader.instanceCache_.pop();
				e.setOptions(d);
		...
		nextField() {
			...
			this.fieldCursor_ = this.decoder_.getCursor();
			const a = module$contents$jspb$binary$decoder_BinaryDecoder.readUnsignedVarint32(this.decoder_), b = module$contents$jspb$binary$reader_parseFieldNumber(a), c = module$contents$jspb$binary$reader_parseWireType(a);
		...
		nextFieldIfTagEqualTo(a) {
			...
			const b = this.decoder_.readUnsignedVarint32IfEqualTo(a), c = 0 <= b;
		...
		assertPriorFieldWasRead() {
			if (goog.asserts.ENABLE_ASSERTS && this.nextTag_ !== module$contents$jspb$BinaryConstants_INVALID_TAG) {
				const a = this.decoder_.getCursor();
		...
		skipDelimitedField() {
			...
			const a = module$contents$jspb$binary$decoder_BinaryDecoder.readUnsignedVarint32(this.decoder_);
			this.decoder_.advance(a);
			return a;
		}
		skipFixed32Field() {
		...
		readUnknownField() {
			const a = this.getFieldCursor();
			this.skipField();
			return this.readUnknownFieldsStartingFrom(a);
		}
		readUnknownFieldsStartingFrom(a) {
			if (!this.discardUnknownFields) {
				const b = this.decoder_.getCursor(), c = b - a;
				this.decoder_.setCursor(a);
		...
		readAny(a) {
			...
			const b = module$contents$jspb$BinaryConstants_FieldType;
			switch (a) {
		...
		readSplitZigzagVarint64(a) {
			goog.asserts.assert(this.nextWireType_ == module$contents$jspb$BinaryConstants_WireType.VARINT);
			return module$contents$jspb$binary$decoder_BinaryDecoder.readSplitVarint64(this.decoder_, (b, c) => module$contents$jspb$utils_fromZigzag64(b, c, a));
		}
		readSplitFixed64(a) {
			goog.asserts.assert(this.nextWireType_ == module$contents$jspb$BinaryConstants_WireType.FIXED64);
			return module$contents$jspb$binary$decoder_BinaryDecoder.readSplitFixed64(this.decoder_, a);
		}
		readPackedFieldInto_(a, b) {
		...
		readPackableUint64StringInto(a) {
		...
		readPackableSint64StringInto(a) {
		...
		readPackableFixed64StringInto(a) {
		...
		readPackableSfixed64StringInto(a) {
	...
	jspb.Message.serializeBinaryExtensions = function(a, b, c, d) {
		for (var e in c) {
			...
			var h = d.call(a, g);
			if (null != h) if (g.isMessageType()) if (f.binaryMessageSerializeFn) f.binaryWriterFn.call(b, g.fieldIndex, h, f.binaryMessageSerializeFn);
	...
	jspb.debug.dump_ = function(a) {
		...
		b = a.constructor;
		var e = { $name: b.name || b.displayName };
	...
	var module$contents$jspb$binary$encoder_BinaryEncoder = class {
		...
		writeSignedVarint32(a) {
			...
			if (0 <= a) this.writeUnsignedVarint32(a);
				...
				for (let b = 0; 9 > b; b++) this.buffer_.push(a & 127 | 128), a >>= 7;
				this.buffer_.push(1);
			}
		}
		writeUnsignedVarint64(a) {
			goog.asserts.assert(a == Math.floor(a));
	...
	jspb.arith = {};
	var module$contents$jspb$arith_UInt64 = class module$contents$jspb$arith_UInt64 {
		constructor(a, b) {
			this.lo = a >>> 0;
			this.hi = b >>> 0;
		}
	...
	var module$contents$jspb$arith_Int64 = class module$contents$jspb$arith_Int64 {
		constructor(a, b) {
			this.lo = a >>> 0;
			this.hi = b >>> 0;
		}
	...
	var module$contents$jspb$arith_ALL_32_BITS = 4294967295, module$contents$jspb$arith_TWO_PWR_32_DBL = 4294967296;
	...
	var module$contents$jspb$binary$writer_BinaryWriter = class {
		...
		writeUnknownFields(a) {
			this.pushBlock(this.encoder_.end());
			for (let b = 0; b < a.length; b++) this.pushBlock(module$contents$jspb$unsafe_bytestring_unsafeUint8ArrayFromByteString(a[b]));
		}
		writeSerializedMessage(a, b, c) {
			this.appendUint8Array_(a.subarray(b, c));
		}
		maybeWriteSerializedMessage(a, b, c) {
		...
		getResultBuffer() {
			this.pushBlock(this.encoder_.end());
			const a = new Uint8Array(this.totalLength_), b = this.blocks_, c = b.length;
			let d = 0;
			for (let e = 0; e < c; e++) {
				const f = b[e];
				a.set(f, d);
		...
		writeUnsignedVarint64_(a, b) {
			if (null != b) switch (this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.VARINT), typeof b) {
				case "number":
				...
				case "bigint":
					...
					break;
				default: a = module$contents$jspb$arith_UInt64.fromString(b), this.encoder_.writeSplitVarint64(a.lo, a.hi);
			}
		}
		writeSignedVarint64_(a, b) {
			if (null != b) switch (this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.VARINT), typeof b) {
				case "number":
				...
				case "bigint":
					...
					this.encoder_.writeSplitVarint64(a.lo, a.hi);
					break;
				default: a = module$contents$jspb$arith_Int64.fromString(b), this.encoder_.writeSplitVarint64(a.lo, a.hi);
			}
		}
		...
		writeFixed64(a, b) {
			if (null != b) switch (module$contents$jspb$binary$writer_assertUnsignedInt64(a, b), this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.FIXED64), typeof b) {
				case "number":
				...
				case "bigint":
					...
					break;
				default: a = module$contents$jspb$arith_UInt64.fromString(b), this.encoder_.writeSplitFixed64(a.lo, a.hi);
			}
		}
		writeFixed64String(a, b) {
		...
		writeSfixed64(a, b) {
			if (null != b) switch (module$contents$jspb$binary$writer_assertSignedInt64(a, b), this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.FIXED64), typeof b) {
				case "number":
				...
				case "bigint":
					...
					this.encoder_.writeSplitFixed64(a.lo, a.hi);
					break;
				default: a = module$contents$jspb$arith_Int64.fromString(b), this.encoder_.writeSplitFixed64(a.lo, a.hi);
			}
		}
		writeSfixed64String(a, b) {
		...
		writeSplitFixed64(a, b, c) {
			this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.FIXED64);
			this.encoder_.writeSplitFixed64(b, c);
		}
		writeSplitVarint64(a, b, c) {
			this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.VARINT);
			this.encoder_.writeSplitVarint64(b, c);
		}
		writeSplitZigzagVarint64(a, b, c) {
			this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.VARINT);
			this.encoder_.writeSplitZigzagVarint64(b >>> 0, c >>> 0);
		}
		writeRepeatedInt32(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeSignedVarint32_(a, b[c]);
		}
		writeRepeatedInt64(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeSignedVarint64_(a, b[c]);
		}
		writeRepeatedSplitFixed64(a, b, c, d) {
			if (null != b) for (let e = 0; e < b.length; e++) this.writeSplitFixed64(a, c(b[e]), d(b[e]));
		}
		writeRepeatedSplitVarint64(a, b, c, d) {
			if (null != b) for (let e = 0; e < b.length; e++) this.writeSplitVarint64(a, c(b[e]), d(b[e]));
		}
		writeRepeatedSplitZigzagVarint64(a, b, c, d) {
			if (null != b) for (let e = 0; e < b.length; e++) this.writeSplitZigzagVarint64(a, c(b[e]), d(b[e]));
		}
		writeRepeatedInt64String(a, b) {
			this.writeRepeatedInt64(a, b);
		}
		writeRepeatedUint32(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeUnsignedVarint32_(a, b[c]);
		}
		writeRepeatedUint64(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeUnsignedVarint64_(a, b[c]);
		}
		writeRepeatedUint64String(a, b) {
			this.writeRepeatedUint64(a, b);
		}
		writeRepeatedSint32(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeZigzagVarint32_(a, b[c]);
		}
		writeRepeatedSint64(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeZigzagVarint64_(a, b[c]);
		}
		writeRepeatedSint64String(a, b) {
			this.writeRepeatedSint64(a, b);
		}
		writeRepeatedFixed32(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeFixed32(a, b[c]);
		}
		writeRepeatedFixed64(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeFixed64(a, b[c]);
		}
		writeRepeatedFixed64String(a, b) {
			this.writeRepeatedFixed64(a, b);
		}
		writeRepeatedSfixed32(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeSfixed32(a, b[c]);
		}
		writeRepeatedSfixed64(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeSfixed64(a, b[c]);
		}
		writeRepeatedSfixed64String(a, b) {
			this.writeRepeatedSfixed64(a, b);
		}
		writeRepeatedFloat(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeFloat(a, b[c]);
		}
		writeRepeatedDouble(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeDouble(a, b[c]);
		}
		writeRepeatedBool(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeBool(a, b[c]);
		}
		writeRepeatedEnum(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeEnum(a, b[c]);
		}
		writeRepeatedString(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeString(a, b[c]);
		}
		writeRepeatedBytes(a, b) {
			if (null != b) for (let c = 0; c < b.length; c++) this.writeBytes(a, b[c]);
		}
		writeRepeatedMessage(a, b, c) {
			if (null != b) for (let d = 0; d < b.length; d++) {
				const e = this.beginDelimited_(a);
				c(b[d], this);
				this.endDelimited_(e);
			}
		}
		writeRepeatedGroup(a, b, c) {
			if (null != b) for (let d = 0; d < b.length; d++) this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.START_GROUP), c(b[d], this), this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.END_GROUP);
		}
		writePackedInt32(a, b) {
			if (null != b && b.length) {
				var c = this.beginDelimited_(a);
				for (let d = 0; d < b.length; d++) module$contents$jspb$binary$writer_assertSignedInteger(a, b[d]), this.encoder_.writeSignedVarint32(b[d]);
				this.endDelimited_(c);
			}
		}
		writePackedInt32String(a, b) {
			if (null != b && b.length) {
				var c = this.beginDelimited_(a);
				...
				for (let d = 0; d < b.length; d++) {
					...
					switch (typeof c) {
						...
						case "bigint":
							...
							break;
						default: c = module$contents$jspb$arith_Int64.fromString(c), this.encoder_.writeSplitVarint64(c.lo, c.hi);
					}
				}
				this.endDelimited_(a);
			}
		}
		writePackedSplitFixed64(a, b, c, d) {
			if (null != b) {
				a = this.beginDelimited_(a);
				for (let e = 0; e < b.length; e++) this.encoder_.writeSplitFixed64(c(b[e]), d(b[e]));
				this.endDelimited_(a);
			}
		}
		writePackedSplitVarint64(a, b, c, d) {
			if (null != b) {
				a = this.beginDelimited_(a);
				for (let e = 0; e < b.length; e++) this.encoder_.writeSplitVarint64(c(b[e]), d(b[e]));
				this.endDelimited_(a);
			}
		}
		writePackedSplitZigzagVarint64(a, b, c, d) {
			if (null != b) {
				a = this.beginDelimited_(a);
				var e = this.encoder_;
				for (let f = 0; f < b.length; f++) e.writeSplitZigzagVarint64(c(b[f]), d(b[f]));
				this.endDelimited_(a);
			}
		}
		writePackedInt64String(a, b) {
			this.writePackedInt64(a, b);
		}
		writePackedUint32(a, b) {
			if (null != b && b.length) {
				a = this.beginDelimited_(a);
				for (let c = 0; c < b.length; c++) this.encoder_.writeUnsignedVarint32(b[c]);
				this.endDelimited_(a);
			}
		}
		writePackedUint64(a, b) {
			if (null != b && b.length) {
				a = this.beginDelimited_(a);
				for (let d = 0; d < b.length; d++) {
					var c = b[d];
					switch (typeof c) {
						...
						case "bigint":
							...
							break;
						default: c = module$contents$jspb$arith_UInt64.fromString(c), this.encoder_.writeSplitVarint64(c.lo, c.hi);
					}
				}
				this.endDelimited_(a);
			}
		}
		writePackedUint64String(a, b) {
			this.writePackedUint64(a, b);
		}
		writePackedSint32(a, b) {
			if (null != b && b.length) {
				a = this.beginDelimited_(a);
				for (let c = 0; c < b.length; c++) this.encoder_.writeZigzagVarint32(b[c]);
				this.endDelimited_(a);
			}
		}
		writePackedSint64(a, b) {
			if (null != b && b.length) {
				a = this.beginDelimited_(a);
				for (let c = 0; c < b.length; c++) {
					...
					switch (typeof d) {
						case "number":
							...
							break;
						default: this.encoder_.writeZigzagVarint64String(d);
					}
				}
				this.endDelimited_(a);
			}
		}
		writePackedSint64String(a, b) {
			this.writePackedSint64(a, b);
		}
		writePackedFixed32(a, b) {
			...
			if (null != b && b.length) for (this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.DELIMITED), this.encoder_.writeUnsignedVarint32(8 * b.length), a = 0; a < b.length; a++) {
				...
				switch (typeof c) {
					...
					case "bigint":
						...
						break;
					default: c = module$contents$jspb$arith_UInt64.fromString(c), this.encoder_.writeSplitFixed64(c.lo, c.hi);
				}
			}
		}
		writePackedFixed64String(a, b) {
			this.writePackedFixed64(a, b);
		}
		writePackedSfixed32(a, b) {
			...
			if (null != b && b.length) for (this.writeFieldHeader_(a, module$contents$jspb$BinaryConstants_WireType.DELIMITED), this.encoder_.writeUnsignedVarint32(8 * b.length), a = 0; a < b.length; a++) {
				...
				switch (typeof c) {
					...
					case "bigint":
						...
						this.encoder_.writeSplitFixed64(c.lo, c.hi);
						break;
					default: c = module$contents$jspb$arith_Int64.fromString(c), this.encoder_.writeSplitFixed64(c.lo, c.hi);
				}
			}
		}
		writePackedSfixed64String(a, b) {
			this.writePackedSfixed64(a, b);
		}
		writePackedFloat(a, b) {
		...
		writePackedEnum(a, b) {
			if (null != b && b.length) {
				a = this.beginDelimited_(a);
				for (let c = 0; c < b.length; c++) this.encoder_.writeEnum(b[c]);
				this.endDelimited_(a);
			}
		}
	};
	...
	function module$contents$jspb$binary$writer_assertSignedInt64(a, b) {
		switch (typeof b) {
			...
			case "number":
				...
				break;
			default: module$contents$jspb$binary$writer_assertThat(a, b, b >= BigInt(-module$contents$jspb$BinaryConstants_TWO_TO_63) && b < BigInt(module$contents$jspb$BinaryConstants_TWO_TO_63));
		}
	}
	function module$contents$jspb$binary$writer_assertUnsignedInt64(a, b) {
		switch (typeof b) {
			...
			case "number":
				...
				break;
			default: module$contents$jspb$binary$writer_assertThat(a, b, b >= BigInt(0) && b < BigInt(module$contents$jspb$BinaryConstants_TWO_TO_64));
		}
	}
...
//#endregion
export { require_google_protobuf as t };
//# sourceMappingURL=google-protobuf-DshEgFcz.js.map